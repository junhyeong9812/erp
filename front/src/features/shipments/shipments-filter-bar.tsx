...
export type ShipmentFilterKey = "ALL" | ShipmentStatus;

interface Props {
  filter: ShipmentFilterKey;
  onFilterChange: (next: ShipmentFilterKey) => void;
  search: string;
  onSearchChange: (next: string) => void;
  counts: Record<ShipmentFilterKey, number>;
}

const FILTER_KEYS: ShipmentFilterKey[] = [
  "ALL",
  "PREPARING",
  "DISPATCHED",
  "COMPLETED",
