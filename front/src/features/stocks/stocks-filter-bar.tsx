...
export type StockFilterKey = "ALL" | "critical" | "warning" | "normal";

interface Props {
  filter: StockFilterKey;
  onFilterChange: (next: StockFilterKey) => void;
  search: string;
  onSearchChange: (next: string) => void;
  counts: Record<StockFilterKey, number>;
}

const FILTER_KEYS: StockFilterKey[] = ["ALL", "critical", "warning", "normal"];

export function StocksFilterBar({
  filter,
  onFilterChange,
  search,
  onSearchChange,
